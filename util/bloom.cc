...
class BloomFilterPolicy : public FilterPolicy {
 public:
  explicit BloomFilterPolicy(std::vector<int> bits_per_key_per_level) : bits_per_key_per_level_(bits_per_key_per_level) {
 ...
 private:
  std::vector<int> bits_per_key_per_level_;
  std::vector<size_t> k_per_level_;
};
}  // namespace

const FilterPolicy* NewBloomFilterPolicy(std::vector<int> bits_per_key_per_level) {
